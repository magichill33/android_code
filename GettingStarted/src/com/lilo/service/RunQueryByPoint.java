 ...
 *
 */
public class RunQueryByPoint extends AsyncTask<String, Void, GetFeaturesResult>
{
	private String url;
	...
	public RunQueryByPoint(String url, String dataSet, Point2D point, Handler handler) {
		super();
		this.url = url;
